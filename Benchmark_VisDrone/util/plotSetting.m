function plotDrawStyle = plotSetting()

plotDrawStyle={   
    struct('color',[1,0,0],'lineStyle','-'),...                             %ºì
    struct('color',[0,1,0],'lineStyle','-'),...                             %ÂÌ
    struct('color',[0,0,1],'lineStyle','-'),...                             %À¶
    struct('color',[1,0,1],'lineStyle','-'),...                             %·Û
