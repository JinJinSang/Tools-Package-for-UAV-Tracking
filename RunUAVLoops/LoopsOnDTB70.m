...
function LoopsOnDTB70(save_dir)                                        % 没有输入，则默认保存在当前文件下下的\loop_results\
%%  读取视频序列和groundtruth
