...
function run_group_UAV123_10fps(save_dir)                                        % 没有输入，则默认保存在当前文件下下的\all_trk_results\
%%  读取视频序列和groundtruth
where_is_your_groundtruth_folder = 'D:\BaiduNetdiskDownload\UAV123_10fps\anno\';        % 包含所有数据集groundtruth文件的路径
where_is_your_UAV123_database_folder = 'D:\BaiduNetdiskDownload\UAV123_10fps\data_seq\';       % 包含所有数据集图片序列的路径
...
if nargin < 1
    save_dir = [main_folder '\group_results\UAV123_10fps\'];              % 保存跑完的结果到指定文件夹
end
